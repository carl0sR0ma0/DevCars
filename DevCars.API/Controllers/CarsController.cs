...
namespace DevCars.API.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        {
            // SE CARRO DE IDENTIFICADOR ID NÃO EXISTIR, RETORNA NOT FOUND.
            // SE NÃO, OK.
        ...
        {
            // SE O CADASTRADO FUNCIONAR, RETORNA CREATED (201).
            // SE OS DADOS DE ENTRADA ESTIVEREM INCORRETOS, RETORNA BAD REQUEST (400).
            // SE O CADASTRTO FUNCIONAR, MAS NÃO TIVER UMA API DE CONSULTA, RETORNA NO CONTENT (204).
        ...
        public IActionResult Put(int id, [FromBody] UpdateCarInputModel model)
        {
            ...
            // SE DADOS DE ENTRDA ESTIVEREM INCORRETOS, RETORNA BAD REQUEST (400).
